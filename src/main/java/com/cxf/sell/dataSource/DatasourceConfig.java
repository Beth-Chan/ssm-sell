package com.cxf.sell.dataSource;
...
/**
 * SSM或者Spring Boot都要用DataSource去连接数据库，为数据库连接提供服务
 * Spring boot少用xml，尽量MyBatis用XML就好
 */
// Configuration注解告诉Spring需要到这个类检索Bean
@Configuration
public class DatasourceConfig {
	private Logger logger = LoggerFactory.getLogger(DatasourceConfig.class);

	// 引入application.yml的配置
